...
public class MeleeRotation : MonoBehaviour
{
    ...
    private void Rotation()
    {
        ...
        if (_meleeWeapon.AnimAttackIsPlaying == true && _meleeWeapon.DirectionAttack != Vector3.zero && _meleeWeapon.CheckerForAttack.Target != null)
        {
            Vector3 direction = (_meleeWeapon.CheckerForAttack.Target.transform.position - transform.position).normalized;
